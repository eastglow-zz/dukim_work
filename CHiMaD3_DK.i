...
[Kernels]
  #Phase-field
  [./time_derivative_p]
    type = TauTimeDerivative
    variable = p
    tau_name = tau_aniso
    coupled_variables = 'dpx dpy'
  [../]
  [./InterfacialE]
    type = myDPMtraining
    variable = p
...
[Executioner]
  ...
  #petsc_options_iname = '-pc_type -pc_factor_mat_solver'  # 0to10s: 29s walltime
  #petsc_options_value = 'lu       superlu_dist'
  petsc_options_iname = '-pc_type -pc_asm_overlap'   # 0to10s: 11s walltime
